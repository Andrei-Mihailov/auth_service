...
@router.post('/create',
             ...
             tags=['Разрешения'])
async def create(permission_params: Annotated[PermissionsParams, Depends()],
...
@router.get('/check/{id_user}',
            ...
            response_description="Ид, название",
            tags=['Разрешения'])
async def check(id_permission: str,
                permission_service: Annotated[PermissionService, Depends()]) -> list[Permission]:
